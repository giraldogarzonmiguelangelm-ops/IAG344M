import logging   #Libreria para mostrar lo que esta pasando en consola
import asyncio   #Permite hacer multitarea, osea permite hacer varias consultas
from collections import defaultdict, deque    #Define una fila de llegada y una de salida

from groq import Groq  #Para poder conectarlo a groq
from telegram import Update   #Para poder conectarlo a telegram
...
groq_client = Groq(api_key=GROQ_API_KEY)  #Instanciando la libreria de groq y le colocamos la llave
...
#Define la funcionalidad para determinar el numero limite de tokens
